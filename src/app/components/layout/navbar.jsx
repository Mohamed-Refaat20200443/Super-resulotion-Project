...
export default function Navbar() {
  ...
  return (
    <nav className="navbar  navbar-expand-lg text-light  bg-dark  border-bottom border-body  fixed-top" data-bs-theme="dark" >
        ...
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          <li className="nav-item">
            <Link className="nav-link nav-link active" href="/home" passHref>
             ...
             <li className="nav-item"><Link className="nav-link nav-link active" href="/HowUsing" passHref>How Using?</Link></li>
...
<li className="nav-item ">
    <ul className=' list-unstyled d-flex       '>
      <li> 
      <i class="mx-2 fa-brands fa-facebook bg-black"></i>
      </li>
      ...
      <li> 
      <i class="mx-2 fa-brands fa-linkedin"></i>
      </li>
