...
<section id="about" className="about py-5  px-5">
  <div className="container py-4 shadow bg-white">
    <div className="row">

      <div className="col-md-6 py-2">

        <div className="part1home p-5">

        <div className="title p-3">
        <h1 class="xl:mb-4 mb-4 md:mb-2 text-black-800"><span class=" text-spyne_blue">Free Online </span>Image / Video Super Resolution</h1>
        </div>

        
        </div>

        <div className="part2home">
      ...
      >
        ...
        <button className='button browse-btn  mb-5' onClick={() => document.querySelector('input[type="file"]').click()}>Browse</button>
